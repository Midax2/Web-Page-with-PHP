...
<body>
    ...
    <article>
        ...
        <div>
            ...
            <img src="Images/momotaro.jpg" alt="Monotaro">
            <p>
            ...
            <p>
                Momo-tarō był odpowiedzią na modlitwy pewnej bezdzietnej pary. Jednego dnia żona, która prała w górskim strumieniu ubrania, zauważyła ogromną brzoskwinię płynącą z prądem. Zabrała ją do domu i gdy, razem z mężem, rozłupała wielki owoc, wewnątrz, zamiast pestki, znalazła ślicznego chłopczyka.

                Chłopiec natychmiast wyjaśnił zdumionej parze, że zesłali go bogowie, aby został synem tej pary. Nie wiemy nic o dzieciństwie Momo-tarō. Za to gdy dorósł, wyruszył walczyć z ogrami (oni), które terroryzowały okolicę i uprzykrzały życie mieszkańcom, jak to tylko oni potrafią.

                Na drogę dostał od mamy zapas ciastek z prosa i ruszył na poszukiwanie gniazda demonów, które znajdowało się na Wyspie Ogrów. Po drodze spotkał małpę, bażanta i psa. Podzielił się ze swoimi nowymi znajomymi ciastkami, a ci – w ramach wdzięczności – postanowili pomóc mu pokonać ogry.
            </p>
            <p>
                Po dotarciu na wyspę czwórka przyjaciół rozbiła szajkę oni, spakowała na swój okręt ogrze skarby i wróciła do wioski Momo-tarō, gdzie wszyscy żyli długo, szczęśliwie i dostatnio. Dotyczyło to również innych mieszkańców wsi, którzy nie tylko zostali uwolnieni od uciążliwych sąsiadów, ale jeszcze obdarowani przez Momo-tarō skarbami zabranymi wrednym demonom.

                Pośród cennych przedmiotów odebranych ogrom był też cudowny młotek, który potrząśnięty sypie skarbami. Taki młotek pojawiał się też w opowieści o Calineczku (czy też japońskim Tomciu Paluchu), nosi też np. bóg Daikokuten, jeden z Siedmiorga Bogów Szczęścia.

                Legenda o Momo-tarō pokrywa się w niektórych motywach (zwierzęcy przyjaciele, walka z demonami) z opowieścią o Kin-tarō, czyli Złotym Chłopcu.
            </p>
        </div>
        <div>
            <h2>
            ...
            <img src="Images/urashimataro.jpg" alt="Urashima Taro">
            <p>
        ...
        <div>
            ...
            <img src="Images/genji.jpg" alt="Genji Monogatari">
            <p>
                Opowieść o Księciu Promienistym datuje się na początek XI w. Nazywana bywa nie tylko pierwszą powieścią, pierwszą powieścią psychologiczną lub pierwszą nowoczesną powieścią. Na uwagę zasługuje fakt, że fragment 25. rozdziału poświęcony jest refleksji nt. sztuki powieściowej.

                Utwór składa się z 54 rozdziałów, w których przedstawiono dzieje Księcia Promienistego i jego potomków. Akcja obejmuje mniej więcej 75 lat, a na kartach powieści przewija się ok. 430 postaci.
            </p>
            <p>
        ...
        <div>
            ...
            <img src="Images/urban.jpg" alt="Japan urban legends">
            <ol>
                <li>
                    Gozu
                    <p class="inside_ol">
